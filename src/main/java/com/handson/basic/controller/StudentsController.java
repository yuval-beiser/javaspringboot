        ...
        var res =aFPS().select(List.of(
                ...
                .conditions(List.of(
                        ...
                        aFPSCondition().condition("( s.birth_Date >= :fromBirthDate )")
                                .parameterName("fromBirthDate").value(atUtc(fromBirthDate)).build(),
                        aFPSCondition().condition("( s.birth_Date <= :toBirthDate )")
                                .parameterName("toBirthDate").value(atUtc(toBirthDate)).build(),
                ...
                .build()
                .exec(em, om);
        return ResponseEntity.ok((PaginationAndList) res);
    }
